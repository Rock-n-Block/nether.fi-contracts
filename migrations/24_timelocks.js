...
module.exports = async function (deployer, network) {
    ...
    await deployer.deploy(
        Timelock, DEPLOYER, TIMELOCK_BUFFER, TOKEN_MANAGER, TIMELOCK_MINT_RECEIVER, GLP_MANAGER, REWARD_ROUTER, TIMELOCK_MAX_TOKEN_SUPPLY, TIMELOCK_MARGIN_FEE_BASIS_POINTS, TIMELOCK_MAX_MARGIN_FEE_BASIS_POINTS
    );
